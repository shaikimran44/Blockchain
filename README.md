...
they are four table 1.Animals table contains primary key animal_id , animal_name,species,breed,gender,shelter_arrival,weight_kg 2.Adoptions table contain primary key adoption_id,foreignkey animal_id,foreign key adopter_id,adoption_date,adoption_fee 3.adopters table primary key adopter_id,full_name.email,phone,age and 4.vaccinations table contains primary key vaccine_idmforeign key animal_id,vaccine name ,vaccine_cost ,vaccine_date
